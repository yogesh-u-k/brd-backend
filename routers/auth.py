...
def connect_jira():
    scope = "read%3Ajira-work%20manage%3Ajira-project%20manage%3Ajira-configuration%20write%3Ajira-work"
    state = CLIENT_SECRET
    auth_url = (
        # f"https://auth.atlassian.com/authorize?"
        # f"audience=api.atlassian.com&client_id={CLIENT_ID}&scope={scope}"
